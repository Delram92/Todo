...
<body>
	...
	<div class="panel panel-default">
		<div
			...
			<div class="row ">
				<h2 class="text-uppercase font-weight-light text">Crear una
					tarea</h2>
			</div>
		</div>
			...
			<form method="post" action="add">
				...
				<div class="row form-group ">
					...
					<div class="col-8">
						<input class=" form-control" type="number" name="horas" id="horas"
							required="required" min="1" placeholder="Número de horas" />
					</div>
				</div>
				...
				<div class="row form-group">
					<label for="fechaini" class="col-4 col-form-label">Fecha
						Inicial: </label>
					<div class="col-8">
						<input class="form-control " type="date" maxlength="30"
							name="fechaini" id="fechaini" required="required" />
					</div>
				</div>
