	...
	<div class="container  col-sm-12">
		<div class="panel panel-default">
			<div
				...
				<div class="row ">
					<h2 class="text-uppercase font-weight-light text">Mis tareas</h2>
					
				</div>
				<div class="row col-12 center btn-group">
					<div class="btn-group mr-2 " role="group">
					<a href="add" class="  btn btn-primary">Crear Tarea</a></span>
					</div>
			...
			<div class="table-responsive">
				<table border="1" class="table table-striped  table-bordered">
					...
					<%
						...
						String fechaini;
						String fechafin;
						if (request.getAttribute("listTodo") != null) {

							List<Todo> listtarea = (List<Todo>) request.getAttribute("listTodo");
							System.out.print("Tamaño de mi tarea" + listtarea.size());
					...
					<tr>
						...
						<td><a href="update/<%=c.getTodoid()%>">Editar</a> | <a
							href="delete/<%=c.getTodoid()%>">Eliminar</a> | <a
							href="view/<%=c.getTodoid()%>">Detalle</a></td>
